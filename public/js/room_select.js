...
function renderRooms(rooms, courseId) {
    ...
    grid.innerHTML = rooms.map(room => {
        ...
        return `
            <div class="room-card ${isGlobal ? 'global-room' : ''}" onclick="enterRoom(${courseId}, ${roomIdParam})" id="room-card-${room.id || 'global'}">
                ...
                <div class="room-footer">
                    ...
                    <button class="enter-btn" onclick="event.stopPropagation(); enterRoom(${courseId}, ${roomIdParam})">
